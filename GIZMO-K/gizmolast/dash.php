...
<div class="row" style="background-color:#1b475d;"  >
<div class="col-lg-6" style="background-color:#1b475d;" >
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Age</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
while($row = mysqli_fetch_array($result)) {
	...
	<td><a title="Open Feedback" href="dash.php?q=3&fid='.$id.'"><b></b></a></td>';
