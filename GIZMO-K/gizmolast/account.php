...
?>
<body>
<div class="header"   style="background-color:#1b475d;"  >
<div class="row">
<div class="col-lg-6">
<span class="logo">Quick Quiz</span></div>
...
<div class="bg" style="min-height:611px" >
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>GIZMO</b></a>
    </div>
...
echo'<input type="radio" required name="ans" value="'.$optionid.'">'.$option.'<br /><br />';
}
...
<!--Footer start-->
<div class="row footer" style="background-color:#1b475d;" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Simran Yadav</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">9766480704</h4>
